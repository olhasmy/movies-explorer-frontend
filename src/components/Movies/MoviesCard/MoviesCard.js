...
function MoviesCard({ movie, savedMovies, onAddMovie, onDeleteMovie, onDislikeMovie }) {
    ...
    return (
        <li className="card">
            <div className="card__container">
                ...
                <img
                    className='card__img'
                    src={location === '/saved-movies' ? movie.image : `https://api.nomoreparties.co${movie.image.url}`}
                    alt={movie.nameRU}
